document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
      e.preventDefault();
      generarCV(1); // Genera el PDF en Estilo 1
    });
  
    form.querySelector('[type="submit2"]').addEventListener("click", function (e) {
      e.preventDefault();
      generarCV(2); // Genera el PDF en Estilo 2
    });
  });
  
  // Función principal para generar el CV en diferentes estilos
  function generarCV(estilo) {
    if (!window.jspdf) {
